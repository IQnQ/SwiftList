...
struct APIEndpoints {
    ...
    static func search(query: String, page: Int) -> Endpoint<RepositoriesPage> {
        
        return Endpoint(path: "search/repositories", parameters: ["q":"\(query)+language:swift", "page": page, "per_page":"25"])
    }
